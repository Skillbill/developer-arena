module.exports = {
  ...
  firebase: {
    'generic-error': 'Oops.. si è verificato un errore, riprova più tardi',
  ...
  siteRules: {
    ...
    6: 'I **primi tre** progetti vincitori rimarranno in evidenza nel sito Developer Arena'
  },
  contestBanner: {
    contest: 'Il Contest',
  ...
  api: {
    errors: {
      ...
      network: 'Impossibile raggiungere il servizio'
    }
  },
  project: {
    ...
    repo: 'Repository URL',
    thumb: 'Immagine',
    thumbHint: 'Dimensioni suggerite 960x540 px',
    file: 'File',
    fileHint: 'Dimensione massima {maxDeliverableSize}',
    send: 'Invia!',
    submitted: 'Il tuo progetto è stato inviato',
    edit: 'Modifica il tuo progetto',
    submitOk: 'Progetto inviato con successo',
    editOk: 'Progetto modificato con successo',
    uploading: 'Attendere...',
    requiredFields: 'Campi obbligatori',
    video: 'Video di anteprima',
    invalidYoutubeVideo: 'Inserire un video Youtube',
  ...
  signUp: 'Registrati',
  signIn: 'Accedi',
  signInEmail: 'Accedi con la tua email',
  ...
  verificationEmailResent: 'Una nuova email di verifica è stata inviata',
  ...
  resendVerificationEmail: 'Reinviare una email di verifica',
  email: 'Email',
  password: 'Password',
  ...
  proceedWithProviderButton: 'Procedi con {provider}',
  vote: 'Voto',
  votes: 'Voti',
