module.exports = {
  ...
  siteRules: {
    ...
    1: 'After the **start** of the **Contest** you can submit your changes until the start of the **voting** phase',
    2: 'After the **voting** phase projects will be classified on the amount of reveived **likes**',
